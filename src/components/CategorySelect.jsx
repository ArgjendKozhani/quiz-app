      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-3">
            Choose a <span className="bg-linear-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Category</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {categories.map((cat) => (
            ...
            >
              {/* Gradient accent */}
              <div className={`absolute inset-0 bg-linear-to-br ${cat.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded-2xl`} />

              <div className="relative z-10">
                <div className={`w-14 h-14 rounded-xl bg-linear-to-br ${cat.color} flex items-center justify-center text-2xl mb-4 shadow-lg`}>
                  {cat.icon}
                </div>
